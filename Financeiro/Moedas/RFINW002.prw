...
#Include "APWEBSRV.CH"
/* ===============================================================================
Autor            Anderson Coelho (ALL System Solutions)
Data             27/08/2018
Descrição        WebServices para o consumo da URL abaixo para a consulta das moedas
                 no Banco Central do Brasil.
WSDL Location    https://www3.bcb.gov.br/sgspub/JSP/sgsgeral/FachadaWSSGS.wsdl
Gerado em        27/12/17 14:28:34
...
=============================================================================== */
User Function RFINW002 ; Return  // "dummy" function - Internal Use 
/* -------------------------------------------------------------------------------
