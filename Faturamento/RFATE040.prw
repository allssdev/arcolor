...
ฑฑบPrograma  ณ RFATE040 บ Autor ณAdriano Leonardo      บ Data ณ  18/03/14 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDescricao ณ Rotina criada para permitir busca avan็ada na tela de      บฑฑ
ฑฑบ          ณ cadastro pedidos de venda.                                 บฑฑ
...
If Valtype(cFiltra) == "C" .AND. !Empty(cFiltra)
	...
	bFiltraBrw := {|| FilBrowse(_cAlias,@aIndexSC5,@cFiltra)}
	Eval(bFiltraBrw)
