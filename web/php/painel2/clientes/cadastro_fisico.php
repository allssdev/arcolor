...
<title>Cadastro de Pessoal Física</title>
<script language="javascript" src="../scripts/isCPFCNPJ.js"></script>
<script language="javascript" src="../scripts/isEmpty.js"></script>
</head>

<body>
<form action="../clientes/cadastra_fisico.php" method="post">  
<table width="519" border="0">
  ...
  <tr>
    <td>Número Identidade:</td>
    <td><input type="text" name="nr_ident" size="15" maxlength="13" /> (00.000.000-0)</td>
  </tr>
  <tr>
    <td>CPF:</td>
    <td><input name="nr_cnpjcpf" type="text" id="nr_cnpjcpf" size="27" maxlength="11" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Telefone:</td>
    <td><input type="text" size="2" maxlength="2" name="nr_ddd" /><input type="text" size="15" maxlength="9" name="nr_telefone" /></td>
  </tr>
  <tr>
    <td>Email:</td>
