...
<div class="vercont">
<h1>Ver Cadastros</h1><br />
<table width="200" border="0">
  <tr>
    <td>Pessoa Física:</td>
    <td><input type="button" value="Veja" onclick="abrirPag('forms/exibefis.php');" /></td>
  </tr>
  <tr>
    <td>Pessoa Jurídica:</td>
    <td><input type="button" value="Veja" onclick="abrirPag('forms/exibejur.php');" /></td>
  </tr>
</table>
</div>
<div class="exibirusu">
...
<table width="200" border="0">
  <tr>
    ...
    <td><input type="button" value="Cadastrar" onclick="abrirPag('cadastra_usuarios.php');" /></td>
  </tr>
  <tr>
    <td>Ver Usuários:</td>
    <td><input type="button" value="Veja" onclick="abrirPag('users/exibe_usuario.php');" /></td>
  </tr>
</table>
</div>
<div class="noticias">
