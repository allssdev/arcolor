...
class Config{
	...
	static function Init(){
		...
		//extranet desenvolvimento
			case 'www.devextranet.arcolor.com.br': $array = self::getDevExtranet(); break;
			//extranet desenvolvimento
			case 'devextranet.arcolor.com.br': $array = self::getDevExtranet(); break;
	...
	static function getDevExtranet(){
		...
		/********CONFIG SYSTEM*******/
		$array['http']				=	"http://www.devextranet.arcolor.com.br/";
		$array['nome_empresa']		=	"Arcolor";
		$array['nome_sistema']		=	"Extranet";
