...
<div id="menu5">
  <ul>
	<li><h3><b>&Aacute;rea de Usu&aacute;rios</b></h3></li>
	<li><a href="#" onclick="abrirPag('../usuarios/exibe_usuario.php');">Exibir Usu&aacute;rios</a></li>
    <li><a href="#" onclick="abrirPag('cadastra_usuarios.php')";>Cadastrar Usu&aacute;rios</a></li>
