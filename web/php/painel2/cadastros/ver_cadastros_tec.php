...
<title>Painel de Controle - Cadastros</title>
...
<div id="menu5">
  <ul>
	<li><h3><b>Ver Cadastros</b></h3></li>
   <li><a href="#" onclick="abrirPag('../clientes/exibe_pessoa_fisica.php');">Pessoa F&iacute;sica</a></li>
    <li><a href="#" onclick="abrirPag('../clientes/exibe_pessoa_juridica.php');">Pessoa Jur&iacute;dica</a></li>
    <li><a href="#" onclick="abrirPag('../clientes/busca_clientes.php');">Procurar Pessoas</a></li>
	<li><a href="../painel_tec.php">Voltar ao Painel</a></li>
  </ul>
</div>
</div>
