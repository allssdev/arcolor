	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			...
			STR0002 := "   Este Procedimento Tem Como Objectivo Criar O Ficheiro Pré-formatado Para O Sistema Serasa/"
			STR0003 := " relato  ( relatório de comportamento em negócios ),  cofacturaorme  os  parâmetros  da"
			STR0004 := "Rotina E O Manual De Homologação Da Serasa."
			STR0008 := "Diária"
			STR0012 := "Serasa - produto resumido ( cadeia de caracteres de dados - ip23 )"
			STR0013 := "Erro: Falha Na Tentativa De Ajustar O Repositório"
			STR0014 := "Erro: Falha Na Tentativa De Criar O Repositório"
		ElseIf cPaisLoc == "PTG"
			STR0001 := "Serasa - Relato"
			STR0002 := "   Este Procedimento Tem Como Objectivo Criar O Ficheiro Pré-formatado Para O Sistema Serasa/"
			STR0003 := " relato  ( relatório de comportamento em negócios ),  cofacturaorme  os  parâmetros  da"
